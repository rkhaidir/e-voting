              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <img src="<?= base_url() ?>assets/icon/vote-yea-solid.svg" alt="" class="img-responsive rotate-n-15" width="70">
                  ...
                  ?>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="nopemilih" placeholder="Inputkan Nomor Pemilih...">
